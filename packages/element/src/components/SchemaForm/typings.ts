...
export type ISchemaProps = ISchemaBaseProps & IUnionLayoutType & FormProps;
/** 透传给子组件children的参数: disabled、readOnly、 initialValues */
export type ISchemaChildrenProps = Pick<
  ISchemaBaseProps,
...
/** item节点包裹器的参数 */
export type IItemWrapProps = Omit<IFormItem & IFormInheritProps, 'render'> & {
  render?: (props: ISchemaChildrenProps) => React.ReactNode;
};
