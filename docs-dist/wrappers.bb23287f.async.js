  ...
  [275],
  {
    ...
    27940: function (E, s, n) {
      ...
      var i = n(91896),
        x = n(67294),
        T = JSON.parse(
          '{"menus":{"en-US":{"*":[{"path":"/","title":"element-form","meta":{"order":null}},{"title":"Guide","path":"/guide","meta":{},"children":[{"path":"/guide/element","title":"Element","meta":{}},{"path":"/guide/schema-form-custom","title":"Custom","meta":{}},{"path":"/guide/schema-form-row","title":"Row","meta":{}}]}]}},"locales":[{"name":"en-US","label":"English"}],"navs":{},"title":"element-form","mode":"doc","repository":{"url":"https://github.com/ayiaq1/schema-form","branch":"master"},"theme":{}}',
        ),
        l = n(3182),
        W = n(94043),
        r = n.n(W),
...
export default memo(ListWrap);`,
        y = `import React, { memo } from 'react';
...
export const disabledDate = (current) => {
  ...
  return current && current < moment().endOf('day');
        ...
        N = {
          'element-elementdemo': {
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              Promise.all([n.e(443), n.e(50)]).then(
                                n.bind(n, 97832),
                              )
                            );
                          case 2:
            ...
            previewerProps: {
              sources: {
                _: { tsx: V },
                'service.ts': { import: './service', content: C },
                'http.ts': { import: './http', content: S },
                'src/index.tsx': { import: '../src', content: m },
                'src/components/Element.tsx': {
                  import: './components/Element',
                  content: u,
                },
                'src/components/Field.tsx': { import: './Field', content: c },
                'src/components/Text.tsx': { import: './Text', content: d },
                ...
                'src/components/ListWrap/index.tsx': {
                  import: './ListWrap',
                  content: f,
                },
              ...
              dependencies: {
                ...
                antd: { version: '4.19.3', css: 'antd/dist/antd.css' },
                ahooks: { version: '3.2.0' },
                'react-dom': { version: '>=16.9.0' },
                'omit.js': { version: '2.0.2' },
              },
              defaultShowCode: !0,
          ...
          'element-schemademocustom': {
            ...
            previewerProps: {
              sources: {
                ...
                'config.ts': { import: './config', content: w },
                'tests/utils.ts': { import: '../tests/utils', content: R },
                'service.ts': { import: './service', content: C },
                'http.ts': { import: './http', content: S },
              },
              dependencies: {
          ...
          'element-schemademorow': {
            ...
            previewerProps: {
              sources: {
                _: { tsx: L },
                'utils.ts': { import: './utils', content: B },
                'src/index.tsx': { import: '../src', content: m },
                'src/components/Element.tsx': {
                  import: './components/Element',
                  content: u,
        ...
        A = JSON.parse(
          '{"element":{"default":[{"identifier":"value","description":"props \u4F20\u5165\u7684\u503C","type":"(string | string[]) & string"},{"identifier":"mode","description":"\u6A21\u5F0F\u7C7B\u578B","type":"ModeType"},{"identifier":"ellipsis","description":"\u8D85\u957F\u7701\u7565 true","type":"boolean"},{"identifier":"style","type":"CSSProperties"},{"identifier":"className","type":"string"},{"identifier":"render","type":"unknown"},{"identifier":"onChange","description":"form\u4F20\u5165\u7684","type":"(val?: any) => void"},{"identifier":"type","type":"\\"text\\""}]}}',
        ),
        G = n(18098),
        M = (t) =>
          x.createElement(
            G.Z,
            (0, i.Z)({}, t, { config: T, demos: N, apis: A }),
          );
    },
  },
]);
